...
<html>
	...
	<?php
		...
		if (Utils::getHaRedireccionat() == false) {

			$user_language = getUserLanguage();

			switch (strtolower($user_language)) {
				case 'ca':
					Utils::setHaRedireccionat(true);
					header('Location: ./ca');
					break;
				case 'es':
					Utils::setHaRedireccionat(true);
				...
				case 'gl':
					...
					break;
				default:
					Utils::setHaRedireccionat(true); //Default site english
					break;
			}
